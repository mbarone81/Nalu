...
#ifndef SurfaceForceAndMomentMLWallFunctionProjectedAlgorithm_h
#define SurfaceForceAndMomentMLWallFunctionProjectedAlgorithm_h
...
class SurfaceForceAndMomentMLWallFunctionProjectedAlgorithm : public Algorithm
{
public:

  SurfaceForceAndMomentMLWallFunctionProjectedAlgorithm(
    Realm &realm,
