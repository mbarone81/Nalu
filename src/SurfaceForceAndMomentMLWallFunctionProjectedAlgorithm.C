...
// Class Definition
//==========================================================================
// SurfaceForceAndMomentMLWallFunctionProjectedAlgorithm - post process sigma_ijnjdS and 
...
//-------- constructor -----------------------------------------------------
//--------------------------------------------------------------------------
SurfaceForceAndMomentMLWallFunctionProjectedAlgorithm::SurfaceForceAndMomentMLWallFunctionProjectedAlgorithm(
  Realm &realm,
  ...
  : Algorithm(realm, partVec),
    ...
    tauWall_(nullptr),
    vectorTauWall_(nullptr),
    yplus_(nullptr),
    density_(nullptr),
    viscosity_(nullptr),
    wallNormalDistanceBip_(nullptr),
    vectorTauWallBip_(nullptr),
...
//--------------------------------------------------------------------------
void
SurfaceForceAndMomentMLWallFunctionProjectedAlgorithm::execute()
{
...
//--------------------------------------------------------------------------
void
SurfaceForceAndMomentMLWallFunctionProjectedAlgorithm::pre_work()
{
...
//--------------------------------------------------------------------------
void
SurfaceForceAndMomentMLWallFunctionProjectedAlgorithm::cross_product(
